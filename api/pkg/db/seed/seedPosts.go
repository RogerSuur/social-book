...
var SeedPostsDataSetB = []*SeedPost{
	...
	},
	{
		...
		PrivacyType: enums.Public,
		CreatedAt:   time.Now().Add(time.Hour * -54),
	...
	},
	{
		...
		PrivacyType:   enums.Public,
		CreatedAt:     time.Now().Add(time.Hour * -34),
		LoremComments: 0,
	},
	{
		...
		PrivacyType:   enums.Public,
		CreatedAt:     time.Now().Add(time.Hour * -32),
		LoremComments: 0,
	},
	{
		...
		PrivacyType:   enums.Public,
		CreatedAt:     time.Now().Add(time.Minute * -32),
		LoremComments: 0,
	},
	{
		...
		PrivacyType: enums.Public,
		CreatedAt:   time.Now().Add(time.Minute * -22),
...
var SeedPostsDataSetC = []*SeedPost{
	...
	},
	{
		...
		PrivacyType:   enums.Public,
		CreatedAt:     time.Now().Add(time.Hour * -57),
		LoremComments: 2,
	},
	{
		...
		PrivacyType:   enums.Public,
		CreatedAt:     time.Now().Add(time.Hour * -44),
		LoremComments: 3,
	},
	{
